...
const SongCard = ({ song, isPlaying, activeSong, i, data }) => {
  ...
  return (
    <div className='flex flex-col w-[250px] p-4 bg-gray-200 hover:bg-gray-400 bg-opacity-80 shadow-md shadow-gray-300 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer'>
